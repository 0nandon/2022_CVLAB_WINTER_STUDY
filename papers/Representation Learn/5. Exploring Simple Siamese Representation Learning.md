...
* Siamese networks can naturally introduce [inductive biases](https://velog.io/@euisuk-chung/Inductive-Bias란) for modeling invariance, as by definition 'invariance' means
that two observatinos of the same concept should produce the same outputs.
